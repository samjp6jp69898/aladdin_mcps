...
const auditLogTestDir = mkdtempSync(join(tmpdir(), 'aladdin-admin-auth-test-auditlog-'));
process.env.ALADDIN_ADMIN_AUDIT_LOG_PATH = join(auditLogTestDir, 'audit.jsonl');
