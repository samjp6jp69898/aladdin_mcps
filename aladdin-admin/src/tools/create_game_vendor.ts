/**
 * tools/create_game_vendor.ts — aladdin_admin_game_vendor_admin_create_or_update_game_vendor
 *
...
export function registerCreateGameVendorTool(server: McpServer): void {
    server.registerTool(
        'aladdin_admin_game_vendor_admin_create_or_update_game_vendor',
        {
            ...
            description:
                ...
                '看得到它，需另外呼叫 aladdin_admin_game_vendor_admin_update_platform_game_vendor_status 啟用。' +
