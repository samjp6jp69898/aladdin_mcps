/**
 * tools/create_game_vendor.ts — aladdin_admin_create_game_vendor
 *
...
export function registerCreateGameVendorTool(server: McpServer): void {
    server.registerTool(
        'aladdin_admin_create_game_vendor',
        {
            ...
            description:
                ...
                '看得到它，需另外呼叫 aladdin_admin_update_platform_game_vendor_status 啟用。' +
