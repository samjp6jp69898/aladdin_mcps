/**
 * tools/list_platform_game_vendors.ts — aladdin_admin_game_vendor_admin_list_platform_game_vendors
 *
    ...
    server.registerTool(
        'aladdin_admin_game_vendor_admin_list_platform_game_vendors',
        {
            ...
            description:
                ...
                '跟 aladdin_admin_game_vendor_admin_list_games 不同：那支是全平台共用母表的「某廠商的遊戲清單」，這支是' +
                '「某平台看得到哪些廠商場館、各自 enabled/disabled」，是真正平台化的查詢（RPC 簽名有明確 platformId 參數）。' +
                'platformId 沒有對應的名稱查詢參數，先呼叫 aladdin_admin_platform_management_list_platform_details 取得合法的 platformId。' +
                ...
                '要用 aladdin_admin_platform_management_list_platform_details 回傳的真實 id。',
            inputSchema: {
