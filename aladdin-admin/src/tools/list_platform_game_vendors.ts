/**
 * tools/list_platform_game_vendors.ts — aladdin_admin_list_platform_game_vendors
 *
    ...
    server.registerTool(
        'aladdin_admin_list_platform_game_vendors',
        {
            ...
            description:
                ...
                '要用 aladdin_admin_list_platforms 回傳的真實 id。',
            inputSchema: {
